    ...
    <main className="mx-auto w-full max-w-7xl px-4 pb-8 pt-14">
      ...
      <section className="mt-8 rounded-2xl border bg-card p-6">
        ...
        <ul className="m-0 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
          <li>
            Edit <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">src/routes/index.tsx</code> to customize the home page.
          </li>
          <li>
            Update <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">src/components/Header.tsx</code> and{' '}
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">src/components/Footer.tsx</code> for brand links.
          </li>
          <li>
            Add routes in <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">src/routes</code> and tweak visual tokens in{' '}
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">src/styles.css</code>.
          </li>
        </ul>
      </section>
    </main>
